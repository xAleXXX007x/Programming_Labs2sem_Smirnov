...
{
    public partial class FormAircraftPart : Form
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }

        public AircraftPartViewModel ModelView { get; set; }

        private readonly IPartLogic logic;

        public FormAircraftPart(IPartLogic logic)
        {
            InitializeComponent();
            this.logic = logic;
        }

        private void FormAircraftPart_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ModelView == null)
                {
                    ModelView = new AircraftPartViewModel
                    {
